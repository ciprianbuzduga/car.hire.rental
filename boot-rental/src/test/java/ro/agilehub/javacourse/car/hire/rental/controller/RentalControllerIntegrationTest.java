...
public class RentalControllerIntegrationTest extends MockMvcIntegrationMongoSetup {
	private static final String RENTAL_COLLECTION_NAME = "rental";
	...
	protected String[] getDroppedCollections() {
		return new String[]{ RENTAL_COLLECTION_NAME };
	}
	...
	public static void cleanRentals() {
		staticMongoTemplate.dropCollection(RENTAL_COLLECTION_NAME);
	}
